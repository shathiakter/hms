...
$query = mysql_query("INSERT INTO admin (admin_name, admin_mobile_no, admin_address, admin_email, admin_password, type, gender) VALUES ('$name','$mobile','$address', '$mail','$password', '$type','$gender' )" );
