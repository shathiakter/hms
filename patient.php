...
<html lang="en">
  ...
  <a href="find_doctor.php"><button type="button" class="btn btn-info btn-lg" data-dismiss="modal">Find Doctor's</button></a>
  ...
  <a href="video_call.php"><button type="button" class="btn btn-info btn-lg" data-dismiss="modal">Video Call</button></a>
		...
		<input type="Submit" name="submit" class="btn btn-default cls" value="submit">
          ...
          <button type="button" class="btn btn-default cls" data-dismiss="modal">Close</button>
             ...
             <footer>
                    ...
                    <p style="text-align: center"; >© 2017 HMS Group. All rights reserved.<a href=''>Powered by ShathiMousumi IT</a> </p>
