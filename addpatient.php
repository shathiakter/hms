...
$query = mysql_query("INSERT INTO patient (patient_name, patient_mobile_no, patient_address, patient_email, patient_password, gender, patient_age, patient_blood_group ) VALUES ('$name','$mobile','$address','$mail','$password','$gender','$age','$blood' )" );
