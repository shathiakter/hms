...
<html lang="en">
  ...
  <a href="department.php"><button type="button" class="btn btn-info btn-lg" data-dismiss="modal">Pharmacy</button></a>
  <a href="department.php"><button type="button" class="btn btn-info btn-lg" data-dismiss="modal">Blood Bank</button></a>
  <a href="department.php"><button type="button" class="btn btn-info btn-lg" data-dismiss="modal">ICU</button></a>
  <a href="Prescription.php"><button type="button" class="btn btn-info btn-lg" data-dismiss="modal">View Prescription</button></a>
