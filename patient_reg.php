  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		Name: <input type="text" name="name" id="name" placeholder="Name of Patient" class ="form-control" value="" size="30"><br>
		...
		Age: <input type="text" name="" id="" class ="form-control" value="" size="40"><br>
		Blod Group: <input type="text" name="" id="" class ="form-control" value="" size="40"><br>
