  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		Name: <input type="text" name="name" id="name" placeholder="Name of Staff" class ="form-control" value="" size="30"><br>
		...
		Staff Type: <input type="text" name="name" id="name" class ="form-control" size="30"><br>
		Gender:
